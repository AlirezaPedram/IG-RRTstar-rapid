function [x, P, obstacle_issue, nearest] = sample_polyshape_check(bound, node, In_list_ID, radius_min, radius, obs_polyshape)
...
while ed < radius_min % This checks the distance to the nearest node is greater than radius_min
    ...
    [nearest,ed] = find_nearest(node, In_list_ID, x, P); 
 end
