...
% This function checks the minimunm distance between two line segments 
% [x1_st; x1_end] and [x2_st; x2_end]
% If the above two line segments cross min_dist = 0 and Is_cross = true
...
if is_cross == true
    ...
    % If two line segments does not cross, then calculate the minimum
    % distance.
