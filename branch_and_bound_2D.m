function [node, remove_ID] = branch_and_bound_2D(node, path, In_list_ID, alpha, R, i, ini_st, dim)
...
node_value_end = dist_ig_mat( pos_list, P_list, term_pos.', term_P, alpha, R);
