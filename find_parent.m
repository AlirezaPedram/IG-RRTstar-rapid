...
issue_flag = psuedo_obs_check_line_oct(x, node(nearest), obstacle_edge, R, chi, bound, num_props, prop);
...
% Finally, run "obstacle_check" for these bounding boxes. 
    ...
    for jj = 1:num_nbor
        ...
        [issue_flag(jj)] = psuedo_obs_check_line_oct(x, node_jj, obstacle_edge, R, chi, bound, num_props, prop);
